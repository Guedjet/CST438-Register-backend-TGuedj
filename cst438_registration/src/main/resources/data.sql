...
(1,'test','test@csumb.edu', '$2a$10$u1iLujMbEyqQz/EajffSnuLUMSqG6s2oXu6pto4UJNSm/uFostiOq
','USER', NULL,0),
(2,'david','dwisneski@csumb.edu', '$2a$10$u1iLujMbEyqQz/EajffSnuLUMSqG6s2oXu6pto4UJNSm/uFostiOq
','ADMIN', NULL,0),
(3,'tom', 'trebold@csumb.edu', '$2a$10$u1iLujMbEyqQz/EajffSnuLUMSqG6s2oXu6pto4UJNSm/uFostiOq
','ADMIN', NULL, 0);
